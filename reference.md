# Reference
<details><summary><code>client.<a href="src/gooey/client.py">bulk_runner</a>(...)</code></summary>
<dl>
<dd>
...
**variables_schema:** `typing.Optional[typing.Dict[str, VariableSchema]]` — Schema for variables to be used in the variables input
...
<details><summary><code>client.<a href="src/gooey/client.py">model_trainer</a>(...)</code></summary>
<dl>
<dd>
...
**learning_rate:** `typing.Optional[float]` — The learning rate to use for training the model.
...
**steps:** `typing.Optional[int]` — The number of steps to train the model for.
...
<details><summary><code>client.<a href="src/gooey/client.py">embeddings</a>(...)</code></summary>
<dl>
<dd>
...
**check_document_updates:** `typing.Optional[bool]` 
...
**asr_task:** `typing.Optional[CreateStreamRequestAsrTask]` — Use **{asr_model}** for speech translation from **{asr_language}** to **English**
...
**asr_prompt:** `typing.Optional[str]` — Optional prompt that the model can use as context to better understand the speech and maintain a consistent writing style.
...
**tools:** `typing.Optional[typing.Sequence[str]]` — Use `functions` instead.
...
**ghana_nlp_tts_language:** `typing.Optional[typing.Literal["tw"]]` 
...
**asr_task:** `typing.Optional[VideoBotsPageRequestAsrTask]` — Use **{asr_model}** for speech translation from **{asr_language}** to **English**
...
**translation_source:** `typing.Optional[str]` — This is usually inferred from the spoken language, but in case that is set to Auto detect, you can specify one explicitly.
...
**selected_model:** `typing.Optional[AsrPageRequestSelectedModel]` — Choose a model to transcribe incoming audio messages to text.
...
**input_prompt:** `typing.Optional[str]` — Optional prompt that the model can use as context to better understand the speech and maintain a consistent writing style.
...
**loras:** `typing.Optional[typing.Sequence[LoraWeight]]` 
...
## ModelTrainer
<details><summary><code>client.model_trainer.<a href="src/gooey/model_trainer/client.py">async_model_trainer</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.model_trainer.<a href="src/gooey/model_trainer/client.py">status_model_trainer</a>(...)</code></summary>
<dl>
<dd>
