...
class AsyncVideoBotsRequestMessagesItemContentItem_Text(UniversalBaseModel):
...
class AsyncVideoBotsRequestMessagesItemContentItem_ImageUrl(UniversalBaseModel):
...
AsyncVideoBotsRequestMessagesItemContentItem = typing.Union[
