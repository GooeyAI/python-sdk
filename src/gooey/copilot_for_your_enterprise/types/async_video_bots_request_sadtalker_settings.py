...
class AsyncVideoBotsRequestSadtalkerSettings(UniversalBaseModel):
    still: typing.Optional[bool] = None
    preprocess: typing.Optional[AsyncVideoBotsRequestSadtalkerSettingsPreprocess] = pydantic.Field(default=None)
    """
