...
class CopilotClient:
    ...
    def completion(
        ...
        *,
        ...
        messages: typing.Optional[typing.List[CopilotCompletionRequestMessagesItem]] = None,
        bot_script: typing.Optional[str] = None,
        selected_model: typing.Optional[CopilotCompletionRequestSelectedModel] = None,
