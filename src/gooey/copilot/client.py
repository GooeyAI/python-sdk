...
class CopilotClient:
    ...
    def completion(
        ...
        *,
        ...
        messages: typing.Optional[typing.List[ConversationEntry]] = OMIT,
        ...
        asr_model: typing.Optional[AsrModels] = OMIT,
        ...
        lipsync_model: typing.Optional[LipsyncModels] = OMIT,
        tools: typing.Optional[typing.List[LlmTools]] = OMIT,
