...
class ConversationEntryContentItem_InputAudio(UniversalBaseModel):
    type: typing.Literal["input_audio"] = "input_audio"
    input_audio: typing.Optional[InputAudio] = None
...
ConversationEntryContentItem = typing.Union[
    ConversationEntryContentItem_Text, ConversationEntryContentItem_ImageUrl, ConversationEntryContentItem_InputAudio
]
