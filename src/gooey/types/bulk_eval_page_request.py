...
class BulkEvalPageRequest(UniversalBaseModel):
    functions: typing.Optional[typing.List[BulkEvalPageRequestFunctionsItem]] = None
    ...
    eval_prompts: typing.Optional[typing.List[BulkEvalPageRequestEvalPromptsItem]] = pydantic.Field(default=None)
    """
    ...
    agg_functions: typing.Optional[typing.List[BulkEvalPageRequestAggFunctionsItem]] = pydantic.Field(default=None)
    """
