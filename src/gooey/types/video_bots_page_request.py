...
class VideoBotsPageRequest(UniversalBaseModel):
    ...
    check_document_updates: typing.Optional[bool] = None
    ...
    asr_task: typing.Optional[VideoBotsPageRequestAsrTask] = pydantic.Field(default=None)
    """
    Use **{asr_model}** for speech translation from **{asr_language}** to **English**
    """

    asr_prompt: typing.Optional[str] = pydantic.Field(default=None)
    """
