...
class AsyncLipsyncRequestSadtalkerSettings(UniversalBaseModel):
    still: typing.Optional[bool] = None
    preprocess: typing.Optional[AsyncLipsyncRequestSadtalkerSettingsPreprocess] = pydantic.Field(default=None)
    """
