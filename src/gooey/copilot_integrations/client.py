...
from .types.create_stream_request_asr_task import CreateStreamRequestAsrTask
...
class CopilotIntegrationsClient:
    ...
    def video_bots_stream_create(
        ...
        *,
        ...
        asr_task: typing.Optional[CreateStreamRequestAsrTask] = OMIT,
        ...
        asr_task : typing.Optional[CreateStreamRequestAsrTask]
